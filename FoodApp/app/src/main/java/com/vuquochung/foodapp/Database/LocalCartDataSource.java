package com.vuquochung.foodapp.Database;
...
public class LocalCartDataSource implements CartDataSource{
    ...
    @Override
    public Single<Integer> countItemCart(String uid,String restaurantId) {
        return cartDAO.countItemCart(uid,restaurantId);
    }
